export interface Certificate {
  ...
  description: string;
  date?: string; // only set when a date is actually printed on the certificate
  verifyUrl?: string; // only set when a verification link is actually printed on the certificate
  image: string;
}
...
export const CERTIFICATES: Certificate[] = [
  {
    ...
    image: "/certificates/google-ai-data-analysis.jpg",
  },
  {
  ...
  },
  {
    ...
    date: "May 24, 2026",
    verifyUrl: "https://www.credly.com/badges/e7aaccd2-3990-42d2-be5d-7789d023bfb9",
    image: "/certificates/ibm-ai-fundamentals.jpg",
  },
  {
    slug: "anthropic-ai-fluency",
    title: "AI Fluency: Framework & Foundations",
    issuer: "Anthropic, with University College Cork, Ringling College of Art & Design, and the Higher Education Authority",
    category: "Certification",
    description:
  ...
  },
  {
    ...
    image: "/certificates/saudi-aramco.jpg",
  },
  {
    ...
    image: "/certificates/mowasalat-fifa.jpg",
  },
];

export const CERTIFICATE_CATEGORIES = ["Certification", "Recognition"] as const;
